    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "PlanId", "AnnualPrice", "Description", "IsActive", "MonthlyPrice", "Name" },
                values: new object[,]
                {
                    { 1, 4790m, "Perfect for beginners getting started on their fitness journey.", true, 499m, "Basic" },
                    { 2, 8630m, "For dedicated members who want more access and support.", true, 899m, "Pro" },
                    { 3, 14390m, "The full FitHub experience for serious athletes.", true, 1499m, "Elite" }
                });
